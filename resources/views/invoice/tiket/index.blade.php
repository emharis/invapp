            ...
            <div class="row" >
                <div class="col-sm-12 col-md-12 col-lg-8" >
                    <div class="btn-action-group" >
                        <a class="btn btn-primary  " id="btn-add" href="invoice/tiket/create" ><i class="fa fa-plus-circle" ></i> Tambah Baru</a>
                ...
                <table class="table table-bordered table-condensed table-striped table-hover" id="table-data" >
                    ...
                    <tbody>
                        ...
                        <tr data-rowid="{{$rownum}}" data-id="{{$dt->id}}">
                            ...
                            <td class="text-center" >
                                <a class="btn btn-primary btn-xs" href="invoice/tiket/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
(function ($) {
    ...
    //     location.href = 'invoice/tiket/edit/' + data_id ;        
    // });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','invoice/tiket/delete');
