...
<section class="content-header">
    <h1>
        <a href="invoice/invoice-lain" >Invoice Lain </a> <i class="fa fa-angle-double-right" ></i> New
    </h1>
</section>
...
<form id="form_invoice" method="POST" action="invoice/invoice-lain/insert" >
...
(function ($) {
    ...
    $('#form_invoice').submit(function(){
        ...
        if(can_save){
            ...
            var newform = $('<form>').attr('method','POST').attr('action','invoice/invoice-lain/insert');
