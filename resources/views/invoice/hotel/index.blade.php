            ...
            <div class="row" >
                <div class="col-sm-12 col-md-12 col-lg-8" >
                    <div class="btn-action-group" >
                        <a class="btn btn-primary  " id="btn-add" href="invoice/hotel/create" ><i class="fa fa-plus-circle" ></i> Tambah Baru</a>
                ...
                <table class="table table-bordered table-condensed table-striped table-hover" id="table-data" >
                    ...
                    <tbody>
                        ...
                        <tr data-rowid="{{$rownum}}" data-id="{{$dt->id}}">
                            ...
                            <td class="text-center" >
                                <a class="btn btn-primary btn-xs" href="invoice/hotel/edit/{{$dt->id}}" ><i class="fa fa-edit" ></i></a>

                                <a class="btn btn-success btn-xs" target="_blank" data-toggle="tooltip" title="Cetak Invoice" href="invoice/hotel/cetak-invoice/{{$dt->id}}" ><i class="fa fa-file-text-o" ></i></a>
                                <a class="btn btn-warning btn-xs" target="_blank" data-toggle="tooltip" title="Cetak Kwitansi" href="invoice/hotel/cetak-kwitansi/{{$dt->id}}" ><i class="fa fa-file-text-o" ></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
(function ($) {
    ...
    //     location.href = 'invoice/hotel/edit/' + data_id ;        
    // });
    ...
    $('#btn-delete').click(function(e){
        if(confirm('Anda akan menhapus data ini?')){
            ...
            var deleteForm = $('<form>').attr('method','POST').attr('action','invoice/hotel/delete');
