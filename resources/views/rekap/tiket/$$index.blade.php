...
(function ($) {
    ...
    $('input[name=filter_option]').change(function(){
        ...
        if(val == 'maskapai'){
            ...
            $('input[name=nama_customer]').attr('readonly','readonly').val('');
            $('input[name=nama_penumpang]').attr('readonly','readonly').val('');
            $('input[name=kantor]').attr('readonly','readonly').val('');
        }else if(val == 'customer'){
            $('input[name=nama_customer]').removeAttr('readonly').val('');
            $('input[name=maskapai]').attr('readonly','readonly').val('');
            $('input[name=nama_penumpang]').attr('readonly','readonly').val('');
            $('input[name=kantor]').attr('readonly','readonly').val('');
        }else if(val == 'penumpang'){
            $('input[name=nama_penumpang]').removeAttr('readonly').val('');
            $('input[name=nama_customer]').attr('readonly','readonly').val('');
            $('input[name=maskapai]').attr('readonly','readonly').val('');
            $('input[name=kantor]').attr('readonly','readonly').val('');
        }else if(val == 'kantor'){
