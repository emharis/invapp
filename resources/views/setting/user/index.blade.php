...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header with-border" >
            <a class="btn btn-primary " id="btn-add" href="setting/user/create" ><i class="fa fa-plus-circle" ></i> Tambah Baru</a>
            <a class="btn btn-danger hide" id="btn-delete" href="#" ><i class="fa fa-trash-o" ></i> Hapus</a>
